...
export const Sidebar = () => {
  ...
  return (
    <div className="fixed left-0 top-0 h-screen w-72 bg-white dark:bg-black-1 hidden xl:flex flex-col items-center py-10 gap-14 text-black dark:text-white font-bevietnampro border-r-none rounded-r-[24px] shadow-sidebar">
